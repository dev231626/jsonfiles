...
let thumbnailDomItems = thumbnail.querySelectorAll('.item')
    ...
    if(n === 'next' ){
        ...
        // if prev move the item from the last of an item to first lenght - 1 (if whole actual lenght 6 starting from zero the array lenght is 5 counting from zero or  binary which represents 6 elements in the array  )
